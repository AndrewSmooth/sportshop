# Generated by Django 4.1.1 on 2023-05-13 10:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('composition', models.ManyToManyField(to='backend.composition')),
                ('sizes', models.ManyToManyField(to='backend.size')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.item', verbose_name='Объявление')),
            ],
            options={
